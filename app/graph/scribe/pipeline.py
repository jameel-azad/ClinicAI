...
def build_scribe_pipeline():
    ...
    graph.add_node("fhir_coding", fhir_coding_node)
    ...
    graph.add_edge("soap_generator", "extract_entities")
    graph.add_edge("extract_entities", "fhir_coding")
    graph.add_edge("fhir_coding", "grounding_check")
